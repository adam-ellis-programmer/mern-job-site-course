...
const DashboardLayout = ({ queryClient }) => {
  ...
  // The interceptor is a global mechanism that validates the user session for every request and logs the user out if invalid.
  // The loader is route-specific, fetching required data and redirecting to another route if an error occurs.
  ...
  // axios interceptors to handle errors
  useEffect(() => {
